...
| ---------------- | --- | -------- | -------- | ---- | ----- | ------------------------------ |
| max              | 16  | +0.183   | 20.4     | 26.9 | -0.08 | 3                              |
| mean             | 16  | +0.218   | 20.2     | 28.2 | -0.18 | 1                              |
| sum_then_cap     | 16  | +0.218   | 27.8     | 36.2 | -0.95 | 7                              |
| weighted_max     | 16  | +0.207   | 20.1     | 27.2 | -0.10 | 1                              |


(Numbers from the Colab n_seeds=5 run; matches the local n_seeds=3 result within ±0.02 Spearman, confirming the conclusion is stable.)
